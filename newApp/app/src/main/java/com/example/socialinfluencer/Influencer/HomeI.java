...
public class HomeI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Influencer/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
        ref.child("token").setValue(FirebaseInstancne)
        bottomNavigationView= (BottomNavigationView)
